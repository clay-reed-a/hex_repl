var model = {
	...
	adjustSelf: function() {
		...
		// 000 always odd except for two, always prime   
		// 000000 always even, never prime except for two 
		...
		if ((/^#?[0-9a-fA-F]{3,}$/.test(hexStr))) {
			this.extractBlueHex();
		}
	}, 
	logHexSubroutine: function() {
		this.extractRedHex();
		this.extractGreenHex();
		this.extractBlueHex();
